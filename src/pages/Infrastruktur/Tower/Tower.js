...
function Tower() {
  ...
  return (
    <div className="container-fluid">
      ...
      <h6 className="m-0 font-weight-bold text-gray-800">Data Menara Telekomunikasi</h6>
      <div className="row my-4">
        <div className="col-md-5">
          <div className="card">
            <div className="card-body">
              <div className="d-flex justify-content-between">
                <h6 className="m-0 font-weight-bold text-gray-800">Tabel Menara Telekomunikasi di Kota Bandung ({wifi.length})</h6>
                <button className="btn btn-sm btn-primary" onClick={() => setShow(!show)}>Tambah Data</button>
              </div>
              <div className="d-flex justify-content-between">
                <div className="row">
